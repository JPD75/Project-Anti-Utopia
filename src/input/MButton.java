...
public class MButton {
    ...
    public void addListener(MButtonHandeler mbi1, Component parent1){
        visible=true;
        parent = parent1;
        if(!isListened){
            mbi=mbi1;
    ...
    public boolean update(int mx,int my){
        ...
        if(go){
            if(data!=null) mbi.action(name+data,parent);
            if(data==null) mbi.action(name,parent);
        }
        return (go);
    }
